			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'zone.title.label', default: 'Title')}" />
				...
				<g:each in="${zoneInstanceList}" status="i" var="zoneInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${zoneInstance.id}">${fieldValue(bean: zoneInstance, field: "title")}</g:link></td>
