	...
	<body>
		...
		<div id="show-zone" class="content scaffold-show" role="main">
			...
			<ol class="property-list zone">
				...
				<g:if test="${zoneInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="zone.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${zoneInstance}" field="title"/></span>
